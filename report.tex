...
The WLTP-equivalent consumption level used here falls within typical values for compact-to-midsize BEVs.
...
The required power aligns with standard longitudinal vehicle dynamics modeling, where drag dominates at high speed.
...
The grade load follows the usual formulation $F_g = mg \times \text{grade}$.


\section*{4. Charging Capability}

The charge window (10--80\%), usable SOC fraction, and current calculation follow standard Li-ion fast-charging conventions.
